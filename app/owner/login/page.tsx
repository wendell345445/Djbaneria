          ...
          <div className="relative z-10 flex h-full flex-col justify-between gap-8">
            <div className="max-w-2xl">
              ...
              <p className="mt-4 max-w-xl text-sm leading-7 text-white/68">
                Entre com sua conta autorizada para acessar a visão geral da plataforma,
                acompanhar métricas globais e administrar o sistema.
              </p>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <FeatureCard
                number="01"
                title="Visão global"
                description="Veja usuários, workspaces, uso e distribuição de planos."
              />
              <FeatureCard
                number="02"
                title="Área separada"
                description="Fluxo próprio para o owner, sem misturar com o painel comum."
              />
              <FeatureCard
                number="03"
                title="Acesso protegido"
                description="Somente contas autorizadas podem entrar nessa área."
              />
            </div>
          </div>
        </section>
