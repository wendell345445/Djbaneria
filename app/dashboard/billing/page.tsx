      ...
      <div className="mb-7 flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
        <div className="max-w-3xl">
          ...
          <p className="mt-2 text-sm leading-6 text-white/60">
            Acompanhe o consumo do período, veja o plano atual e entenda como os créditos funcionam.
          </p>
        </div>
      ...
      <section className="grid gap-6 xl:grid-cols-[minmax(0,1.05fr)_360px]">
            ...
            <div>
              ...
              <p className="mt-3 max-w-2xl text-sm leading-7 text-white/70">
                {isAdmin
                  ...
                  : planMeta[String(summary.plan) as keyof typeof planMeta]?.description ?? "Seu plano define quantos créditos você pode usar por mês."}
              </p>
            </div>
        ...
        <div className="grid gap-4">
          <InfoCard
            ...
            value={usageLabel}
            helper={isAdmin ? "Uso liberado para testes" : "Consumo acumulado no período atual"}
          />
          <InfoCard
            title="Restantes"
            value={remainingLabel}
            helper={isAdmin ? "Sem limite no modo admin" : "Disponíveis para novas gerações e alterações"}
          />
          <InfoCard
            title="Regras rápidas"
            value="1 crédito"
            helper="Cada geração de banner consome 1 crédito. Cada alteração da arte também consome 1 crédito."
          />
        </div>
      </section>
          ...
          <div className="mb-5 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <h2 className="mt-2 text-xl font-semibold text-white">
                Compare os níveis disponíveis
              </h2>
            </div>

            <p className="text-sm text-white/55">
              Upgrade visual por enquanto. Integração de cobrança pode ser conectada depois.
            </p>
          </div>
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    ...
                    {isCurrent ? (
                      ...
                      <span className="rounded-full border border-violet-300/20 bg-violet-300/10 px-3 py-1 text-[10px] uppercase tracking-[0.16em] text-violet-100">
                        Upgrade
                      </span>
                    ) : null}
                  </div>
