...
export const ProfessionalImageJobStatus = {
  PENDING: 'PENDING',
...
export const MotionPreset = {
  ...
  FESTIVAL_DROP_PRO: 'FESTIVAL_DROP_PRO',
  VIRAL_REELS_CUT: 'VIRAL_REELS_CUT',
  DARK_TECHNO_RGB: 'DARK_TECHNO_RGB',
  LUXURY_GOLD_CLUB: 'LUXURY_GOLD_CLUB',
  CYBER_RAVE: 'CYBER_RAVE'
} as const
